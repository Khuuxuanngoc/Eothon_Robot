...
/***********Notice and Trouble shooting***************
 ...
 <https://wiki.makerlab.vn/index.php/M%E1%BA%A1ch_ph%C3%A1t_%C3%A2m_thanh_MKL-M11_UART_control_MP3_Player_module>
...
void setup()
{
  ...
  Serial.println();
  Serial.println(F("MKL-M11 UART control MP3 Player module Demo"));
